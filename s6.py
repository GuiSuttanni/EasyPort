...
wf('apps/api/src/modules/project/project.controller.ts', """import { FastifyRequest, FastifyReply, FastifyInstance } from 'fastify';
...
wf('apps/api/src/modules/project/project.route.ts', """import { FastifyInstance } from 'fastify';
