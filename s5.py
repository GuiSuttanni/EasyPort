...
wf('apps/api/src/modules/category/category.controller.ts', """import { FastifyRequest, FastifyReply, FastifyInstance } from 'fastify';
...
wf('apps/api/src/modules/category/category.route.ts', """import { FastifyInstance } from 'fastify';
